...
<body>
	...
	<div class="container">
		...
		<center>
			<h2 style="color:grey; margin-top:20%">Eliminar Post</h2>
		</center>
		...
		<ul>
			<?php $posts = getPostsByAuthor($_SESSION['usuario']);
			foreach ($posts as $post) : ?>
				<li>
					<h2>
						...
						<a href="verficacionEliminacionPost.php?id=<?php echo $post['id'] ?>"><button class="btn btn-primary">Eliminar Post</button></a>
						<h2>
