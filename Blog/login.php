...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (checkUsuario($_POST['usuario'], $_POST['clave'])) {
		session_start();
		$_SESSION['usuario'] = $_POST['usuario'];
		$_POST['usuario'] == "admin" ? header("Location: sesiones1_principal_admin.php") : header("Location: user.php");
	} else {

		echo "<div class=\"error\">";
		echo "<center>Revise usuario y contraseña</center>";
		echo "</div>";
	}
}
	...
	<div class="container">
		...
		<form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
			...
			<div class="col-sm-offset-2 col-sm-10">
				<button type="submit" class="btn btn-primary" alt="Boton Entrar">Entrar</button>
