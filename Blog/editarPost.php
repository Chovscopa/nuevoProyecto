...
<center><h2 style="color:grey; margin-top:20%">Blog, Blog, Blog!!!</h2></center>
<center><img src="images/Logo1.png" class="der"></a></center>

        <center><h1>Tus Posts</h1></center>
        <ul>
            <?php $posts = getPostsByAuthor($_SESSION['usuario']); foreach ($posts as $post): ?> <!--selección por autor-->
                <li>
                    <h2>
						...
						<a href="modificarPost.php?id=<?php echo $post['id']?>"><button class="btn btn-primary">Modificar Post</button></a>
                    <h2>
