...
<body>
	...
	<div class="container">
		...
		<a href="insertPostt.php"><button class="btn btn-primary">Crear Post</button></a>
		<a href="editarPost.php"><button class="btn btn-primary">Editar Posts</button></a>
		<a href="eliminarPost.php"><button class="btn btn-primary">Eliminar Post</button></a>
